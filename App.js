...
let Day1Condition = document.getElementById("Day1Condition");
...
let Day2Condition = document.getElementById("Day2Condition");
...
let Day3Condition = document.getElementById("Day3Condition");
...
let Day4Condition = document.getElementById("Day4Condition");
...
let Day5Condition = document.getElementById("Day5Condition");
...
let Day6Condition = document.getElementById("Day6Condition");
...
// let WeatherConditionBox = document.getElementById("WeatherConditionBox");
...
const ShowWeather = (WeatherData) =>{
    ...
    Day1Condition.innerHTML =  `${WeatherData.forecast.forecastday[1].day.condition.text}`;
    ...
    Day2Condition.innerHTML =  `${WeatherData.forecast.forecastday[2].day.condition.text}`;
    ...
    Day3Condition.innerHTML =  `${WeatherData.forecast.forecastday[3].day.condition.text}`;
    ...
    Day4Condition.innerHTML =  `${WeatherData.forecast.forecastday[4].day.condition.text}`;
    ...
    Day5Condition.innerHTML =  `${WeatherData.forecast.forecastday[5].day.condition.text}`;
    ...
    Day6Condition.innerHTML =  `${WeatherData.forecast.forecastday[6].day.condition.text}`;
    ...
    // WeatherConditionBox.append.innerHTML =`<img src="//cdn.weatherapi.com/weather/64x64/day/116.png" alt="Weather-Icon">`
};
